...
// Define hashed values for each role
const HASHED_USER_ROLE = sha256Hash("user");
const HASHED_ADMIN_ROLE = sha256Hash("admin");
const HASHED_clerk_ROLE = sha256Hash("clerk");
